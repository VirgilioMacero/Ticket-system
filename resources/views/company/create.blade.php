<x-app-layout>
    ...
    <div class="py-12 bg-yellow-500">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form class="bg-white overflow-hidden shadow-xl sm:rounded-lg grid grid-cols-1" action="{{route('company.store')}}" method="POST">
                @csrf
                ...
                <div class=" px-4 py-10 grid grid-cols-2 gap-2">
                    ...
                    <div>
                        ...
                        <x-input placeholder="www.example.com" value="{{old('CompanyWebPage')}}" id="CompanyWebPage" name="CompanyWebPage" class="w-full" />
                    </div> 
