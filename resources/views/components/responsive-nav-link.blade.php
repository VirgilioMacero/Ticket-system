...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-yellow-400 text-left text-base font-medium text-yellow-600 bg-yellow-50 focus:outline-none focus:text-yellow-700 focus:bg-yellow-200 focus:border-yellow-700 transition duration-150 ease-in-out'
