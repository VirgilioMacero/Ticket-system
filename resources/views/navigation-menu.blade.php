        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->type == "SUP_USER")
                        
                    <x-nav-link href="{{ route('company.index') }}" :active="request()->routeIs('company.index')">
                        {{ __('Companies') }}
                    </x-nav-link>
                    
                    <x-nav-link href="{{ route('area_service.index') }}" :active="request()->routeIs('area_service.index')">
                        {{ __('Services') }}
                    </x-nav-link>                     
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->type == "SUP_USER")
                ...
                <x-responsive-nav-link href="{{ route('area_service.index') }}" :active="request()->routeIs('area_service.index')">
                    {{ __('Services') }}
                </x-responsive-nav-link>                 
